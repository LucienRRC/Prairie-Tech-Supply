...
require "active_admin/views/components/active_admin_form"
require "active_admin/views/components/attributes_table"
require "active_admin/views/components/index_list"
require "active_admin/views/components/paginated_collection"
